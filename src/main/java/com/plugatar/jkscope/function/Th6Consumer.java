...
/**
 * The {@link java.util.function.Consumer} specialization with {@code [Object,Object,Object,Object,Object,Object->void]}
 ...
 */
@FunctionalInterface
public interface Th6Consumer<T1, T2, T3, T4, T5, T6, E extends Throwable> {
   ...
   */
  void accept(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6) throws E;
   ...
   */
  static <T1, T2, T3, T4, T5, T6, E extends Throwable> Th6Consumer<T1, T2, T3, T4, T5, T6, E> of(final Th6Consumer<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? extends E> consumer) {
   ...
   */
  static <T1, T2, T3, T4, T5, T6> Th6Consumer<T1, T2, T3, T4, T5, T6, RuntimeException> unchecked(final Th6Consumer<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ?> origin) {
