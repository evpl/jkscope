 ...
 */
@FunctionalInterface
public interface Th4Consumer<T1, T2, T3, T4, E extends Throwable> {
   ...
   */
  static <T1, T2, T3, T4, E extends Throwable> Th4Consumer<T1, T2, T3, T4, E> of(final Th4Consumer<? super T1, ? super T2, ? super T3, ? super T4, ? extends E> consumer) {
   ...
   */
  static <T1, T2, T3, T4> Th4Consumer<T1, T2, T3, T4, RuntimeException> unchecked(final Th4Consumer<? super T1, ? super T2, ? super T3, ? super T4, ?> origin) {
