 ...
 */
@FunctionalInterface
public interface Th5Function<T1, T2, T3, T4, T5, R, E extends Throwable> {
   ...
   */
  static <T1, T2, T3, T4, T5, R, E extends Throwable> Th5Function<T1, T2, T3, T4, T5, R, E> of(final Th5Function<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? extends R, ?> function) {
   ...
   */
  static <T1, T2, T3, T4, T5, R> Th5Function<T1, T2, T3, T4, T5, R, RuntimeException> unchecked(final Th5Function<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? extends R, ?> origin) {
