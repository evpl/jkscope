...
/**
 * The {@link java.util.function.Function} specialization with {@code [int,Object,Object,Object,Object->Object]}
 ...
 */
@FunctionalInterface
public interface Th5FunctionIntObj4<T1, T2, T3, T4, R, E extends Throwable> {
   ...
   */
  R apply(int value, T1 t1, T2 t2, T3 t3, T4 t4) throws E;
   ...
   */
  static <T1, T2, T3, T4, R, E extends Throwable> Th5FunctionIntObj4<T1, T2, T3, T4, R, E> of(final Th5FunctionIntObj4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R, ? extends E> function) {
   ...
   */
  static <T1, T2, T3, T4, R> Th5FunctionIntObj4<T1, T2, T3, T4, R, RuntimeException> unchecked(final Th5FunctionIntObj4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R, ?> origin) {
