...
/**
 * The {@link java.util.function.Function} specialization with {@code [int,Object,Object->Object]} signature that might
 * throw an exception.
 *
 ...
 */
@FunctionalInterface
public interface Th3FunctionIntObj2<T1, T2, R, E extends Throwable> {
   ...
   */
  R apply(int value, T1 t1, T2 t2) throws E;
   ...
   */
  static <T1, T2, R, E extends Throwable> Th3FunctionIntObj2<T1, T2, R, E> of(final Th3FunctionIntObj2<? super T1, ? super T2, ? extends R, ? extends E> function) {
   ...
   */
  static <T1, T2, R> Th3FunctionIntObj2<T1, T2, R, RuntimeException> unchecked(final Th3FunctionIntObj2<? super T1, ? super T2, ? extends R, ?> origin) {
