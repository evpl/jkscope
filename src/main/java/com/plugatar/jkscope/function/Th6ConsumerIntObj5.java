...
/**
 * The {@link java.util.function.Consumer} specialization with {@code [int,Object,Object,Object,Object,Object->void]}
 ...
 * @param <T4> the type of the fifth input argument
 * @param <T5> the type of the sixth input argument
 * @param <E>  the type of the throwing exception
 */
@FunctionalInterface
public interface Th6ConsumerIntObj5<T1, T2, T3, T4, T5, E extends Throwable> {
   ...
   * @param t5    the sixth input argument
   * @throws E if consumer threw exception
   */
  void accept(int value, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5) throws E;
   ...
   */
  static <T1, T2, T3, T4, T5, E extends Throwable> Th6ConsumerIntObj5<T1, T2, T3, T4, T5, E> of(final Th6ConsumerIntObj5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? extends E> consumer) {
   ...
   */
  static <T1, T2, T3, T4, T5> Th6ConsumerIntObj5<T1, T2, T3, T4, T5, RuntimeException> unchecked(final Th6ConsumerIntObj5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ?> origin) {
